class SprySqlpage < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/programmablemd/packages/releases/download/v0.1.8/spry-sqlpage-macos.tar.gz"
  ...
  on_linux do
    url "https://github.com/programmablemd/packages/releases/download/v0.1.8/spry-sqlpage_0.1.8-ubuntu22.04u1_amd64.deb"
