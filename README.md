...
```bash
# Ubuntu 22.04 (Jammy)
wget https://github.com/programmablemd/packages/releases/download/v0.101.3/spry_0.101.3-ubuntu22.04u1_amd64.deb
sudo dpkg -i spry_0.101.3-ubuntu22.04u1_amd64.deb

# Debian 12 (Bookworm)
wget https://github.com/programmablemd/packages/releases/download/v0.101.3/spry_0.101.3-debian12u1_amd64.deb
sudo dpkg -i spry_0.101.3-debian12u1_amd64.deb
```
...
wget https://github.com/programmablemd/packages/releases/download/v0.101.3/spry-macos.tar.gz
...
# https://github.com/programmablemd/packages/releases/download/v0.101.3/spry-windows.zip
