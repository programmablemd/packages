...
```bash
# Ubuntu 22.04 (Jammy)
wget https://github.com/programmablemd/packages/releases/download/v0.100.6/spry-sqlpage_0.100.6-ubuntu22.04u1_amd64.deb
sudo dpkg -i spry-sqlpage_0.100.6-ubuntu22.04u1_amd64.deb

# Debian 12 (Bookworm)
wget https://github.com/programmablemd/packages/releases/download/v0.100.6/spry-sqlpage_0.100.6-debian12u1_amd64.deb
sudo dpkg -i spry-sqlpage_0.100.6-debian12u1_amd64.deb
```
...
wget https://github.com/programmablemd/packages/releases/download/v0.100.6/spry-macos.tar.gz
...
# https://github.com/programmablemd/packages/releases/download/v0.100.6/spry-windows.zip
