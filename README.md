...
# Debian 12 (Bookworm)
wget https://github.com/programmablemd/packages/releases/download/v1.7.6/spry_1.7.6-debian12u1_amd64.deb
sudo dpkg -i spry_1.7.6-debian12u1_amd64.deb
```
...
# https://github.com/programmablemd/packages/releases/download/v1.7.6/spry-windows.zip
